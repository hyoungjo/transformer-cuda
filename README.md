...
The C++ implementation is a naive, single-threaded CPU execution of the GPT-2 architecture. It serves as the lower bound baseline and an architecture template, which is ported to the CUDA implementation.
